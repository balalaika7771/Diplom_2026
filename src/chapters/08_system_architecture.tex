...
Каждый источник нормализуется: $D_{\text{normalized}} = \bigcup_{i=1}^{n} f_{\text{normalize},i}(D_i)$. Время сбора определяется самым медленным источником: $T_{\text{collection}} = \max_{i} T_{\text{collect},i}$.
