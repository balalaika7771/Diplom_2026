...
\begin{figure}[H]
\centering
\begin{tikzpicture}[node distance=0.8cm, auto, scale=1.0, transform shape, font=\small]
...
\begin{figure}[H]
\centering
\begin{tikzpicture}[node distance=1.5cm, auto, scale=1.0, transform shape, font=\small]
