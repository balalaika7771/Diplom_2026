...
\hline
Облачные платформы & Отказ VM, деградация сети, перегрузка API & руб. 5--50 тыс./мин & Снижение MTTR на 40--45\% \\
\hline
Финансовые системы & Задержки транзакций, сбои процессинга & руб. 10--100 тыс./мин & Рост Availability до 99.95\% \\
\hline
E-commerce & Недоступность каталога, сбои оплаты & руб. 1--20 тыс./мин & Снижение потерь выручки \\
\hline
Телеком & Деградация качества, отказы узлов & руб. 2--30 тыс./мин & Автоматизация SLA-контроля \\
\hline
\end{tabular}
\end{table}
...
\hline
Стоимость простоя, $C_{\min}$ & руб. 500/мин & Медиана для среднего SaaS \cite{amazon_outage_cost} \\
\hline
$\text{MTTR}_b$ & 79.1 мин & Таблица~\ref{tab:experiments_summary} \\
\hline
$\text{MTTR}_a$ & 43.7 мин & Таблица~\ref{tab:experiments_summary} \\
\hline
Инфраструктура агентов, $C_{\text{infra}}$ & руб. 18\,000/год & 2 сервера + облачные ресурсы \\
\hline
Операционные расходы, $C_{\text{ops}}$ & руб. 12\,000/год & 0.1 FTE инженера \\
\hline
Разработка/настройка, $C_{\text{dev}}$ & руб. 15\,000 & Единоразово, амортизация 3 года \\
\hline
\end{tabular}
\end{table}

Подставляя значения для базового сценария ($C_{\min} = {}$руб. 500/мин):

\begin{align}
\text{Экономия} &= 240 \cdot 500 \cdot (79.1 - 43.7) = 240 \cdot 500 \cdot 35.4 \notag \\
&= 4\,248\,000 \ \text{руб./год} \label{eq:savings_calc}
\end{align}

\begin{equation}
\text{TCO}_{\text{год}} = 18\,000 + 12\,000 + \frac{15\,000}{3} = 35\,000 \ \text{руб./год}
\label{eq:tco_calc}
\end{equation}
...
\hline
\textbf{Сценарий} & \textbf{$C_{\min}$, руб.} & \textbf{Экономия/год} & \textbf{ROI} & \textbf{Окупаемость} \\
\hline
Консервативный & 100 & руб. 0.85 млн & 23 & 5.4 мес \\
\hline
\textbf{Базовый} & \textbf{500} & \textbf{руб. 4.25 млн} & \textbf{120} & \textbf{1.1 мес} \\
\hline
Оптимистичный & 5\,000 & руб. 42.5 млн & 1\,213 & 3 дня \\
\hline
\end{tabular}
\end{table}

Консервативный сценарий (руб. 100/мин) соответствует небольшим внутренним системам, базовый (руб. 500/мин) --- среднему SaaS-бизнесу, оптимистичный (руб. 5\,000/мин) --- крупным платформам уровня Tier-1 \cite{amazon_outage_cost}. Экономическая целесообразность подтверждается даже в консервативном сценарии: ROI = 23 при окупаемости менее 6 месяцев.
...
\begin{axis}[
    xlabel={Стоимость простоя, руб./мин},
    ylabel={Годовая экономия, млн руб.},
...
Экономическая целесообразность сохраняется при стоимости простоя от руб. 100/мин и частоте инцидентов от 4 в месяц, что соответствует большинству production-систем масштаба более 20 сервисов.
