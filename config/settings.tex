...
{\thechapter}{20pt}{\Large\MakeUppercase}
...
\usepackage{fancyvrb}
\DefineVerbatimEnvironment{codeverbatim}{Verbatim}{frame=single, framesep=2mm, fontsize=\small, numbers=left, numbersep=3pt}
...
\lstset{
    ...
    showtabs=false,
    tabsize=2,
    basicstyle=\small\fontfamily{cmtt}\selectfont, % Use cmtt for better compatibility
